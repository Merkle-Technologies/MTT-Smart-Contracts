...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    IBEP20 public USDT;                                                    // USDT Address from which user needs to invest
     ...
     */
    constructor (uint256 rate, address payable wallet, IBEP20 token, IBEP20 _stableCoin, address _icoWallet) public {
     ...
     * @param amount Recipient of the token purchase
    **/
    ...
    function _deliverTokens(address beneficiary, uint256 tokenAmount) internal {
        token().transferFrom(icoWallet, beneficiary, tokenAmount);
    }
