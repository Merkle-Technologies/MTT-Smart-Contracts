    ...
    Ownable
{
    ...
    uint256 public investorMinCap = 1000000000000000000;                    // 100 USDT
    // uint256 public investorMinCap = 100000000000000000000;               // 100 USDT
    uint256 public investorHardCap = 500000000000000000000000;              // 500,000 USDT
        ...
        internal
    {
        ...
        require(
            ...
            "MerkleTokenCrowdsale : Investment amount is Below allowed investment amount"
        );
        require(
                _newContribution <= investorHardCap,
            "MerkleTokenCrowdsale : Investment amount is Higher than allowed investment amount"
        );
